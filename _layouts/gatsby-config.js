...
module.exports = {
  ...
  pathPrefix: PATH_PREFIX || `/brain-dump`, // b. If you are using Netlify/Vercel, your can keep it this way
  siteMetadata: {
    // some SEO configs using by gatsby-theme-kb
    title: `Brain Dump`, // Replace it with your site's title
    author: `Brady T`, // Replace it with your name
