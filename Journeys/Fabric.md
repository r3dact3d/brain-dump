...
> Tip: you can use the **summarize_pattern** or **summarize_prompt** pattern on any pattern
> ```bash
> $ cd ~/.config/fabric/patterns/
> $ cat summarize_prompt/system.md | fabric -sp summarize_pattern
> ```
...
[Pattern Template]: <../Ideas/Pattern Template.md> "IDENTITY"
